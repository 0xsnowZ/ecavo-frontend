...
const PALETTE = [
  ...
  { bg: 'bg-green-50',  icon: 'text-green-500',  border: 'hover:border-green-300' },
  { bg: 'bg-purple-50', icon: 'text-purple-500', border: 'hover:border-purple-300' },
  { bg: 'bg-orange-50', icon: 'text-orange-500', border: 'hover:border-orange-300' },
  ...
  { bg: 'bg-indigo-50', icon: 'text-indigo-500', border: 'hover:border-indigo-300' },
  { bg: 'bg-yellow-50', icon: 'text-yellow-600', border: 'hover:border-yellow-300' },
      ...
      <div className="container-main py-10">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-auto pt-2 border-t border-border">
                    ...
                    <ArrowRight size={14} className="text-muted group-hover:text-primary group-hover:translate-x-1 rtl:group-hover:-translate-x-1 transition-all" />
                  </div>
                </Link>
              );
            })}
        ...
        {!loading && categories.some(c => c.children?.length > 0) && (
          <div className="mt-12 space-y-6">
            <h2 className="text-lg font-bold text-secondary">{isAr ? 'الأقسام الفرعية' : 'Sub-categories'}</h2>
